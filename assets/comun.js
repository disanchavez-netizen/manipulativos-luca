...
window.Luca = {
  navegar(pagina) {
    const ROUTES = { Index: 'index', Abaco: 'abaco', CuboBase10: 'cubo-base10', Tangram: 'tangram', Fracciones: 'fracciones' };
  ...
  fab: {
    ...
    init(cfg) {
      ...
      const RING = [
        ...
        { at: 8,  id: 'back',    icon: 'arrow-left', tip: 'Volver al menú',                     run: () => { Luca.navegar('Index'); this.setOpen(false); } },
...
window.addEventListener('DOMContentLoaded', function () { Luca.icons(); });
